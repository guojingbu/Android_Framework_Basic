...
public class DateUtil {
     ...
     * @return
     */
    public static String formatTimeToDay(Context mCntext, String dateStr) {
        ...
        try {
            ...
            if (minute <= 0) {
                return mCntext.getString(R.string.just_now);

            } else if (minute / 60 == 0) {
                return minute + mCntext.getString(R.string.time_minute);
            } else if (minute / (60 * 24) == 0) {
                return minute / 60 + mCntext.getString(R.string.time_hour);

            } else if (minute / (60 * 24 * 30) == 0) {
                return minute / (60 * 24) + mCntext.getString(R.string.time_day);
    ...
    public static int getCurrTimePosition(String currdate) {
        String date = formatDate(new Date(), FormatType.yyyyMMdd);
