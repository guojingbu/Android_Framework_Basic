...
public class UpdateDialogFragment extends DialogFragment {
    ...
    public static UpdateDialogFragment newInstance(Builder builder) {
        UpdateDialogFragment commonDialogFragment = new UpdateDialogFragment();
        ...
        args.putString("contentTtile", builder.contentTitle);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (arguments != null) {
            ...
            contentTitle = arguments.getString("contentTtile");
        ...
        TextView mTvContentTile = view.findViewById(R.id.txt_content_title);
        ...
        if (!TextUtils.isEmpty(contentTitle)) {
            mTvContentTile.setText(contentTitle);
        } else {
            mTvContentTile.setVisibility(View.GONE);
        }
